...
const defaultDeployStatus: DeployStatus = {
  backend: {
    status: 'unknown',
    port: 0,
  },
...
const normalizeDeployStatus = (data: Partial<DeployStatus> | null | undefined): DeployStatus => ({
  backend: {
    ...defaultDeployStatus.backend,
    ...(data?.backend || {}),
  },
  cuda: {
    ...defaultDeployStatus.cuda,
    ...(data?.cuda || {}),
  },
  whisper: {
    ...defaultDeployStatus.whisper,
    ...(data?.whisper || {}),
  },
  ffmpeg: {
    ...defaultDeployStatus.ffmpeg,
    ...(data?.ffmpeg || {}),
  },
})
...
export default function Monitor() {
  ...
  const fetchStatus = useCallback(async () => {
    try {
      ...
      setStatus(normalizeDeployStatus(data))
